...
module.exports = {
    ...
    diffInDays, roundPrice, diffInMilliSeconds, diffInMonths, hasNumberX, hasNumberXPattern,
    broadcastToStore, addSocket, removeSocket, getSocket, getActiveSocketsInfo, getLastDayOfMonthISO
}
